...
const translations = {
    it: {
        ...
        'reservation.durationInfo': '⏱️ <strong>Pranzo/Cena:</strong> tavolo garantito per 2 ore | <strong>Aperitivo:</strong> 1,5 ore<br><small>Se non ci sono prenotazioni successive, la permanenza può essere prolungata.</small>',
    ...
    en: {
        ...
        'reservation.durationInfo': '⏱️ <strong>Lunch/Dinner:</strong> table guaranteed for 2 hours | <strong>Aperitivo:</strong> 1.5 hours<br><small>If no subsequent bookings, your stay can be extended.</small>',
