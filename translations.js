...
const translations = {
    it: {
        ...
        'reservation.success': 'Prenotazione Registrata!',
        'reservation.successMsg': 'Riceverai un\'email di conferma con tutti i dettagli della prenotazione.',
    ...
    en: {
        ...
        'reservation.success': 'Reservation Registered!',
        'reservation.successMsg': 'You will receive a confirmation email with all the reservation details.',
